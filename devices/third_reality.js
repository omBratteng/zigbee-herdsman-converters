...
const definitions = [
    ...
    },
    {
        ...
        extend: [(0, modernExtend_1.forcePowerSource)({ powerSource: 'Battery' })],
        fromZigbee: [fromZigbee_1.default.cover_position_tilt, fromZigbee_1.default.battery],
        toZigbee: [toZigbee_1.default.cover_state, toZigbee_1.default.cover_position_tilt],
        exposes: [e.cover_position(), e.battery()],
    },
    ...
    },
    {
        ...
        extend: [(0, modernExtend_2.battery)({ voltage: true }), (0, modernExtend_1.forcePowerSource)({ powerSource: 'Battery' })],
        ota: ota.zigbeeOTA,
    },
    {
        ...
        extend: [(0, modernExtend_2.temperature)(), (0, modernExtend_2.humidity)(), (0, modernExtend_2.battery)(), (0, modernExtend_1.forcePowerSource)({ powerSource: 'Battery' })],
        ota: ota.zigbeeOTA,
    },
    {
    ...
    },
    {
        ...
        extend: [
            ...
            (0, modernExtend_2.deviceAddCustomCluster)('r3Specialcluster', {
                ID: 0xfc00,
                manufacturerCode: 0x130d,
                attributes: {
                    cold_down_time: { ID: 0x0003, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                    local_routin_time: { ID: 0x0004, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                    lux_threshold: { ID: 0x0005, type: zigbee_herdsman_1.Zcl.DataType.UINT16 },
                },
                commands: {},
                commandsResponse: {},
            }),
